...
const ActorInformation=()=>{
    ...
    const actorDetails=async()=>{
       const personDetail =  await fetch(MOVIE_ACTOR_DETAILS+personId+"?language=en-US",options);
       const personCredits =  await fetch(MOVIE_ACTOR_DETAILS+personId+"/movie_credits?language=en-US",options);
