...
const ActorProfile = () => {
  ...
  return (
    <>
      <div className=" ">
        <div className="md:flex bg-pink-300 md:rounded-lg">
          <div className="bg-cyan-200 md:m-5 md:min-w-[400px] md:rounded-lg">
            ...
            {actorDetails?.birthday ? <div className="bg-yellow-200 my-3 p-2 md:flex-2 md:text-xl md:p-4 md:space-y-3 md:mx-2 md:rounded-lg">
              <h1>Age : {age}</h1>
            ...
            </div> : <div className="text-xl mt-3 font-semibold text-center">No Information Present</div>}
          </div>
          {
           overview && <div className="bg-gray-400 p-2 md:my-5 md:mr-5 md:rounded-lg">
