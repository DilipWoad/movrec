        ...
        <div className="bg-slate-400 flex p-2 gap-2 rounded-lg text-wrap sm:text-nowrap">
          <div className="flex  w-40">
            <div className="min-w-32 sm:w-full">
              <img
                className="hover:shadow-2xl hover:shadow-black rounded-lg"
                src={MOVIE_IMG + poster_path}
                alt="movie_poster"
              />
              <div className="mt-2 text-lg sm:text-3xl font-bold">
                {vote_average}
          ...
          <div className="min-w-24 w-full sm:w-auto px-2 bg-slate-300 flex flex-col rounded-lg">
            <div className=" flex-1 flex flex-col px-2 justify-between">
              <div className="text-xl sm:text-3xl font-semibold sm:h-20 flex flex-col justify-between">
                ...
                <div className="text-sm sm:text-lg font-medium">{`(${release_date.substring(
                  0,
                  4
                )})`}</div>
              </div>
            ...
            {directed && (
              <div className="px-2 text-sm mb-2 sm:mb-0 sm:h-[68px] sm:text-lg">
                <span className="text-[15px] sm:text-lg font-bold">
                  Directed By:-
                </span>{" "}
                {directed[0]?.name}
              </div>
