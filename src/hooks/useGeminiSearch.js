...
const useGeminiSearch = async(searchPrompt)=>{
    ...
    searchPrompt + 
    ". Only give me names of 24 movies that matches the given prompt description with, comma seperated like the example result given ahead. Example Result: Gadar, Sholay, Don, Golmaal,Koi Mil Gaya,...etc"
